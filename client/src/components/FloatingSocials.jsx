...
function FloatingSocials() {
    return (
        <div className="fixed bottom-6 right-6 z-[999] flex flex-col gap-4">
            ...
            {/* Phone - Mobile Only */}
            <a
                href="tel:+917470567335"
                className="md:hidden w-14 h-14 rounded-full bg-yellow-500 text-white flex items-center justify-center shadow-xl hover:scale-110 hover:shadow-yellow-500/50 transition-all duration-300 animate-pulse"
            >
                <FaPhoneAlt size={22} />
            </a>
