...
if (result.success) {
  ...
  >
    ...
    <option value="सामान्य (45 मिनट - ₹2100 + ₹350)">
      🟢 सामान्य (45 मिनट - ₹2100 + ₹350)
    </option>

    <option value="विशेष (1 घंटा 30 मिनट - ₹5100 + ₹500)">
      🟡 विशेष (1 घंटा 30 मिनट - ₹5100 + ₹500)
    </option>

    <option value="महाविशेष (2 घंटे - ₹11000 + ₹700)">
      🔴 महाविशेष (2 घंटे - ₹11000 + ₹700)
    </option>
  </select>
